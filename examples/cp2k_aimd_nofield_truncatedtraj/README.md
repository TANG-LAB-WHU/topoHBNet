...
- **Usage**:
  ...
  - **HPC Cluster Execution (Required for Publication-Quality Physical Equations):**
    ...
    > - **Massive Core Allocation**: Allocates 192 CPU cores (e.g., SLURM `9a14a` partition) to perform parallel multi-run Genetic Programming across tens of thousands of candidate equations.
